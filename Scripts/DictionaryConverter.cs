...
public class DictionaryConverter : MonoBehaviour
{
	...
	public Dictionary<string, string> sample_sDict { get; set; }
    public Dictionary<string, string> sample_rDict { get; set; }
    public Dictionary<string, string[]> btnText_Sample { get; set; }
